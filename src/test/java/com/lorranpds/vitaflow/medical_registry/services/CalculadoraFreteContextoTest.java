...
//    }
    ...
    @Test
    void testandoMap(){
        Map<Integer, String> testandoMap = new HashMap<>();
        testandoMap.put(1, "item 1");
        testandoMap.put(2, "item 2");
        testandoMap.put(3, "item 3");
        testandoMap.put(4, "item 4");

        String valor = testandoMap.get(2);
