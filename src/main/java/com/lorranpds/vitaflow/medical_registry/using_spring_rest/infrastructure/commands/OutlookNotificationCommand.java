 ...
 */
public class OutlookNotificationCommand implements EmailCommand {
    private final EmailEngine engine;
    private final String recipient;
    private final String message;

    public OutlookNotificationCommand(EmailEngine engine, String recipient, String message){
        this.engine = engine;
    ...
    @Override
    public void execute(){
        engine.sendViaOutlook(recipient, message);
    }
}
